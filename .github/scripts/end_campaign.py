...
2026-08-18 に GitHub Actions から自動実行される。冪等（何度実行しても安全）。"""
import sys, pathlib
...
REPL_HTML = [
    ...
    ('<tr><th>体験レッスン</th><td><strong style="color:#c0392b">無料</strong>'
     '<span style="font-size:.85em;color:#c0392b">（8月17日受講分まで）</span>'
     '<br><span style="font-size:.85em;color:#777">※通常2,750円 ／ 1回</span></td></tr>',
     '<tr><th>体験レッスン</th><td>2,750円 ／ 1回</td></tr>'),
    # 料金注釈
    ('<span>※ チェロ・コースの体験レッスンは</span><span>2026年8月17日ご受講分まで無料です。</span><span>（ヴァイオリン・ヴィオラは2,750円）</span><br>',
     ''),
    # リード文
    ('<strong>2026年8月17日ご受講分まで、チェロ・コースの体験レッスンを無料で受けていただけます。</strong>',
     ''),
    # ヒーローのバッジ
    ('<span>チェロ体験レッスン無料</span>', '<span>体験レッスンあり</span>'),
    # FAQ表示
    ('<div class="answer">はい、体験レッスンをご用意しています。チェロ・コースは2026年8月17日ご受講分まで無料キャンペーン中です（ヴァイオリン・ヴィオラ・コースは2,750円・税込／1回）。「自分にもできるかな？」という段階のご相談も大歓迎です。まずはお気軽にお問い合わせください。</div>',
     '<div class="answer">はい、体験レッスン（2,750円・税込／1回）をご用意しています。「自分にもできるかな？」という段階のご相談も大歓迎です。まずはお気軽にお問い合わせください。</div>'),
    # FAQ構造化データ
    ('"text": "はい、体験レッスンをご用意しています。チェロ・コースは2026年8月17日ご受講分まで無料キャンペーン中です。ヴァイオリン・ヴィオラ・コースは2,750円（税込・1回）です。まずはお気軽にお問い合わせください。"',
     '"text": "はい、体験レッスン（2,750円・税込／1回）をご用意しています。まずはお気軽にお問い合わせください。"'),
    # 事業構造化データ description
    ('チェロ・コースの体験レッスンは2026年8月17日受講分まで無料。', '体験レッスンあり。'),
    ...
    ('''      {
        ...
        "description": "チェロ・コースの体験レッスンは2026年8月17日ご受講分まで無料キャンペーン中です。通常価格は2,750円（税込）。"
      },
      {
        "@type": "Offer",
    ...
    ('チェロ体験レッスンが8/17まで無料！仙台市青葉区のチェロ・バイオリン・ビオラ教室。大人の初心者・3歳から70代まで歓迎、生徒の大半が未経験スタートです。',
     '仙台市青葉区のチェロ・バイオリン・ビオラ教室。大人の初心者・3歳から70代まで歓迎、生徒の大半が未経験スタートです。体験レッスン2,750円。'),
    ('チェロ体験レッスンが8/17まで無料！仙台市青葉区のチェロ・バイオリン・ビオラ教室。大人の初心者も3歳のお子さまも歓迎。',
...
REPL_LLMS = [
    ('チェロ・コースの体験レッスンは2026年8月17日ご受講分まで無料キャンペーン中。', ''),
    ('\n  ※ チェロ・コースの体験レッスンは2026年8月17日ご受講分まで無料キャンペーン中です（ヴァイオリン・ヴィオラ・コースは2,750円）。', ''),
]
